...
module "IAM" {
  source = "./modules/IAM"
  iam_sns_snsuser_sns_topic = module.SNS.main_iam_permissions_user_creation_topic != "" ? module.SNS.main_iam_permissions_user_creation_topic : "null"
  iam_sns_snsuser_sns_topic_arn = module.SNS.main_iam_permissions_user_creation_topic_arn != "" ? module.SNS.main_iam_permissions_user_creation_topic_arn : "null"
  providers = {
    aws = aws.Root
  }
}
