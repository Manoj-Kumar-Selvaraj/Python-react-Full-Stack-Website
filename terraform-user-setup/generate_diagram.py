...
def extract_services(json_data):
    ...
    def parse_module(parent_module):
            for module in parent_module["module"]:
                ...
                if service_type.startswith("aws_"):
                    ...
                    dependency_matrix["service_type"] = []
                for dependency_module in module["dependencies"]:
                    
                    dependency_matrix["service_type"].append(dependencies)
                parse_module(child)

    parent_module = json_data.get("resources", {})
    print(f"Parsing parent module...")  # Debugging: print parsing start message
    parse_module(parent_module)
